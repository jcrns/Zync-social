...
import 'package:bbdsocial/screens/fragments/SVAddPostFragment.dart';
import 'package:bbdsocial/screens/fragments/SVHomeFragment.dart';
import 'package:bbdsocial/screens/fragments/UserProfileFragment.dart';
import 'package:bbdsocial/screens/fragments/SVSearchFragment.dart';
import 'package:bbdsocial/screens/home/screens/SVForumScreen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon:
            Image.asset('images/socialv/icons/ic_Paper.png', height: 24, width: 24, fit: BoxFit.cover, color: context.iconColor).paddingTop(12),
            label: '',
            activeIcon: Image.asset('images/socialv/icons/ic_Paper.png', height: 24, width: 24, fit: BoxFit.cover).paddingTop(12),
          ),
          BottomNavigationBarItem(
